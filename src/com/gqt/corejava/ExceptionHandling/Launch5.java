...
public class Launch5 {
	public static void main(String[] args) {
		...
		//specific multi-catch
			...
			System.out.println("Arithmetic Exception was generated and handled or " + "Input Mismatch Exception was generated and handled");
		}
		
		catch(NegativeArraySizeException | ArrayIndexOutOfBoundsException e1) {
