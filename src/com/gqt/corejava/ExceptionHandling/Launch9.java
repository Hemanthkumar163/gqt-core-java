...
class UnderAgeException extends Exception{
	public String getMessage() {
		return  "The age is less than the minimum age.Applictaion cannot be processed";
	}
}
class OverAgeException extends Exception{
	public String getMessage() {
		return  "The age is more than the maximum age.Applictaion cannot be processed";
	}
}
class Candidate{
	int age;
	...
	void validate() throws UnderAgeException,OverAgeException {
		if (age <18) {
			...
			System.out.println("Application cannot be processed");
		}
	}
}
class Matrimony{
