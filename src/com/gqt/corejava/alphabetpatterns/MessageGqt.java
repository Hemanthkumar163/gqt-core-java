 ...
 * @author hemanth
 * @category patterns
 * @description This is an example for message for gqt in alphabetical pattern
 */
public class MessageGqt {
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<n;i++) {
			for(int j=0;j<n;j++) {
				if(i==0 || j==0  || i==n-1|| i==n/2 && j>=n/2|| j==n-1 && i>=n/2 && i!=n-1) {
					System.out.print("# ");
				}
				else {
					System.out.print("  ");
			...
			System.out.print("  ");
			for(int j=0;j<n;j++) {
				if(i==n/2|| j==0 && i>=n/2  || i==n-1 || j==n-1) {
					System.out.print("# ");
				}
				else {
					System.out.print("  ");
